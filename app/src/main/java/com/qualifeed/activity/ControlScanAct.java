...
public class ControlScanAct extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    public String TAG = "ControlScanAct";
    ...
    private void initViews() {
        ...
        Glide.with(ControlScanAct.this).load(DataManager.getInstance().getUserData(ControlScanAct.this).result.image)
                .override(40,40)
    ...
    private void scanQrCode(String code) {
        DataManager.getInstance().showProgressMessage(ControlScanAct.this, getString(R.string.please_wait));
            ...
            public void onResponse(Call<QrCodeModel> call, Response<QrCodeModel> response) {
                ...
                try {
                    ...
                    if (data.status.equals("1")) {
                        startActivity(new Intent(ControlScanAct.this,CheckControlAct.class).putExtra("scanData",responseString));
                        finish();
                        ...
                        handler.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                mScannerView.resumeCameraPreview(ControlScanAct.this);
                            }
                        }, 2000);
                        App.showToast(ControlScanAct.this, data.message, Toast.LENGTH_SHORT);
                    }
    ...
    public void handleResult(Result rawResult) {
        ...
        if(NetworkAvailablity.checkNetworkStatus(ControlScanAct.this))  scanQrCode(rawResult.getText());
        else App.showToast(ControlScanAct.this,getString(R.string.network_failure), Toast.LENGTH_LONG);
    ...
    private boolean checkPermissions() {
        if (ActivityCompat.checkSelfPermission(ControlScanAct.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED  ) {
            return true;
        }
        return false;
    }
