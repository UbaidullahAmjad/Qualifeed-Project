...
import com.qualifeed.databinding.ActivityAddDefectBinding;
...
public class SuspectDefectAct extends AppCompatActivity {
    public String TAG ="SuspectDefectAct";
    ActivityAddDefectBinding binding;
    ...
    private void initViews() {
        ...
        binding.btnSave.setOnClickListener(v -> {
            if(str_image_path.equals(""))
            ...
            else if(binding.edTitle.getText().toString().equals(""))
                Toast.makeText(this, getString(R.string.please_add_title), Toast.LENGTH_SHORT).show();
                ...
                if (NetworkAvailablity.checkNetworkStatus(SuspectDefectAct.this)) addSuspectDefect();
                else
                    App.showToast(SuspectDefectAct.this, getString(R.string.network_failure), Toast.LENGTH_LONG);
            }
        });
    ...
    public void showImageSelection() {
        ...
        final Dialog dialog = new Dialog(SuspectDefectAct.this);
    ...
    private void openCamera() {
        ...
        uriSavedImage = FileProvider.getUriForFile(SuspectDefectAct.this,
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == REQUEST_CAMERA) {
                ...
                Glide.with(SuspectDefectAct.this)
                        .load(str_image_path)
                        .centerCrop()
                        .into(binding.ivPic);
    ...
    public boolean checkPermisssionForReadStorage() {
        if (ContextCompat.checkSelfPermission(SuspectDefectAct.this,
                Manifest.permission.CAMERA)
                != PackageManager.PERMISSION_GRANTED

                ||

                ContextCompat.checkSelfPermission(SuspectDefectAct.this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(SuspectDefectAct.this,
                    Manifest.permission.CAMERA)

                    ||

                    ActivityCompat.shouldShowRequestPermissionRationale(SuspectDefectAct.this,
                            Manifest.permission.READ_EXTERNAL_STORAGE)
                    ||
                    ActivityCompat.shouldShowRequestPermissionRationale(SuspectDefectAct.this,
                            Manifest.permission.WRITE_EXTERNAL_STORAGE)
                ...
                ActivityCompat.requestPermissions(SuspectDefectAct.this,
            ...
            case MY_PERMISSION_CONSTANT: {
                ...
                if (grantResults.length > 0) {
                    ...
                    if (camera && read_external_storage && write_external_storage) {
                        ...
                        Toast.makeText(SuspectDefectAct.this, " permission denied, boo! Disable the functionality that depends on this permission.", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(SuspectDefectAct.this, "  permission denied, boo! Disable the functionality that depends on this permission.", Toast.LENGTH_SHORT).show();
                }
    ...
    private void addSuspectDefect() {
        DataManager.getInstance().showProgressMessage(SuspectDefectAct.this, getString(R.string.please_wait));
        ...
        RequestBody workerId = RequestBody.create(MediaType.parse("text/plain"), DataManager.getInstance().getUserData(SuspectDefectAct.this).result.id);
        RequestBody comment = RequestBody.create(MediaType.parse("text/plain"), binding.edComment.getText().toString());

        Call<Map<String, String>> signupCall = apiInterface.addSuspectDefect(title,ref,typ1,typ2,datee,workerId, comment, filePart);
            ...
            public void onResponse(Call<Map<String, String>> call, Response<Map<String, String>> response) {
                ...
                try {
                    ...
                    if (data.get("status").equals("1")) {
                        ...
                        Log.e("MapMap", "Add Suspect Defect RESPONSE" + dataResponse);
                        Toast.makeText(SuspectDefectAct.this, getString(R.string.defect_add_successfully), Toast.LENGTH_SHORT).show();
                        finish();
                    } else if (data.get("status").equals("0")) {
                        Toast.makeText(SuspectDefectAct.this, data.get("message"), Toast.LENGTH_SHORT).show();
                    }
