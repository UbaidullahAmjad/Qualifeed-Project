...
public class TrainningAct extends AppCompatActivity implements onPosListener {
    public String TAG ="TrainningAct";
    ...
    private void initViews() {
        ...
        adapter =  new TrainingAdapter(TrainningAct.this,arrayList,TrainningAct.this);
        binding.rvTraining.setAdapter(adapter);


        if (NetworkAvailablity.checkNetworkStatus(TrainningAct.this)) getAllDefect(/*qrCodeModel.getId(),*/qrCodeModel.getProductType1(),qrCodeModel.getProductType2());
        else
            App.showToast(TrainningAct.this, getString(R.string.network_failure), Toast.LENGTH_LONG);



        binding.btnDone.setOnClickListener(v -> {
            SessionManager.writeString(TrainningAct.this,"ChkTraining","true");
  ...
  /*  private void getAddedDefact() {
        DataManager.getInstance().showProgressMessage(TrainningAct.this, getString(R.string.please_wait));
    ...
    public void onPos(int pos,String type) {
        startActivity(new Intent(TrainningAct.this,DetailAct.class).putExtra("img",arrayList.get(pos).getProductDefectsImage())
        .putExtra("title",arrayList.get(pos).getProductref()).putExtra("des",arrayList.get(pos).getComment()));
    }
}
